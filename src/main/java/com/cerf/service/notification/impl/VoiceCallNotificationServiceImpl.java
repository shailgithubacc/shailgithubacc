...
public class VoiceCallNotificationServiceImpl implements MsgNotificationService {
    ...
    public void sendNotification(RequestDTO requestDTO, List<VendorDTO> vendorList) {
        ...
        int maxRetryAllowed = Integer.parseInt(Optional.ofNullable(applicationConfig.getProperty("CHANNEL-IVR-RETRY-COUNTS")).orElse("1"));
