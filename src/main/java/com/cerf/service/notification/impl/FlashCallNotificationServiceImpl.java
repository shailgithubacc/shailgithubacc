...
public class FlashCallNotificationServiceImpl implements MsgNotificationService {
    ...
    public void sendNotification(RequestDTO requestDTO, List<VendorDTO> vendorList) {
        ...
        int maxRetryAllowed = Integer.parseInt(Optional.ofNullable(applicationConfig.getProperty("CHANNEL-FLASH-RETRY-COUNTS")).orElse("1"));
