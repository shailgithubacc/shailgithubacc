...
public class SMSNotificationServiceImpl implements MsgNotificationService {
    ...
    public void sendNotification(RequestDTO requestDTO, List<VendorDTO> vendorList) {
        ...
        int maxRetryAllowed = Integer.parseInt(Optional.ofNullable(applicationConfig.getProperty("CHANNEL-SMS-RETRY-COUNTS")).orElse("1"));
